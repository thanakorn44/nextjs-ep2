    ...
    return (
        <header className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 h-[300px] flex justify-center items-center">
            <div className="text-center">
                ...
                <form onSubmit={handleForm}  className="flex items-center mt-3">
                    <input onChange={handleInput} type="text" className="w-full  rounded-md border-gray-300 px-3 py-2 text-gray-700 shadow-md" placeholder="Pokemon Name ..." />
